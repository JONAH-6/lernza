...
vi.mock("@stellar/freighter-api", () => ({
  ...
  // The hook subscribes to wallet changes; a no-op stub is enough for these
  // tests, which exercise connect/disconnect/boot rather than live polling.
...
describe("useWallet - disconnect", () => {
  it("sets connected false and stores DISCONNECTED_KEY in localStorage", async () => {
    mockFreighter.requestAccess.mockResolvedValue({ address: "GABC1234" })
